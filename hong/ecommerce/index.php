            ...
            <div class="nav-buttons">
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <div class="user-profile">
                        <?php
                        // Corrected mysqli prepared statement and file path handling 
                        $stmt = mysqli_prepare($conn, "SELECT profilePic FROM login WHERE userId = ?");
                        ...
                        // Check if the profile picture exists and construct the correct path
                        if ($profilePic && file_exists('../uploads/profile/' . basename($profilePic))) {
                            $profilePicPath = '../uploads/profile/' . basename($profilePic);
                        } else {
                            $profilePicPath = '../uploads/profile/default-avatar.png';
                        }
                        ?>
